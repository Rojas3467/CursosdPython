...
class Customer:
    ...
    def inquire_car(self, car):
        ...
        print(f"El coche {car.brand} {car.model} esta {availability} y cuesta {car.get_price()}")
...
class Dealership:
    ...
    def show_available_cars(self):
        print("Coche disponibles en la concensionaria:")
...
# Cliente consultar un coche
customer1.inquire_car(car1)

# Cliente comprar un coche
